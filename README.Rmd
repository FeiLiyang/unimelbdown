...
Ismay's [thesisdown](https://github.com/ismayc/thesisdown), tailored by 
Luke Zappia's [unimelbdown](https://github.com/lazappi/unimelbdown) and 
merged by Liyang Fei.
