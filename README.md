...
not for producing a final document.

The Latex template is adapted from John Papandriopoulos [PhD Thesis
Template](https://github.com/jpap/phd-thesis-template).
...
1.  Use the **New R Markdown** dialog to select **Unimelb Thesis** and
    enter `index` as the name:

    <figure>
    <img src="thesis_rmd.png" alt="New R Markdown" />
...
2.  Edit the individual R Markdown files to change the content. To
    reorder or remove sections edit `_bookdown.yml`.

3.  Press **Knit** on the `index.Rmd` file to get your thesis in the
    desired format.
